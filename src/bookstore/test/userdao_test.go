...
func TestSave(t *testing.T) {
	_ = dao.SaveUser("admin3", "123456", "admin@atguigu.com")
}
...
func TestGetPageBooksByPrice(t *testing.T) {
	page, _ := dao.GetBooksByPrice("3", "10", "30")
	fmt.Println("当前页是：", page.PageNo)
	fmt.Println("总页数是：", page.TotalPageNo)
	fmt.Println("总记录数是：", page.TotalRecord)
	fmt.Println("当前页中的图书有：")
...
func TestDeleteSession(t *testing.T) {
	dao.DeleteSession("13838381438")
}

func TestGetSession(t *testing.T) {
	sess, _ := dao.GetSession("c65d2a76-9447-44cc-5fe8-c183e1414076")
...
func TestGetCartItemByBookID(t *testing.T) {
	cartItem, _ := dao.GetCartItemByBookIDAndCartID("1", "66668888")
...
func TestDeleteCartByCartID(t *testing.T) {
	dao.DeleteCartByCartID("80bb8008-8383-47d0-4694-5eae94f39ffd")
}

func TestDeleteCartItemByID(t *testing.T) {
	dao.DeleteCartItemByID("21")
}
...
func TestGetOrderItems(t *testing.T) {
	orderItems, _ := dao.GetOrderItemsByOrderID("9a738546-d240-4c1a-7b3d-a3837100977f")
...
func TestUpdateOrderState(t *testing.T) {
	dao.UpdateOrderState("5823f37e-f4e6-4a39-7567-2a7c0fd8e638", 1)
}
